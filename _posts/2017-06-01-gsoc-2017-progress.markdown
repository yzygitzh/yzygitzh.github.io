...
* June 12th - June 18th
    ...
    2. Scale the testing app samples to a more expanded data set. [PENDING]
    3. Improve the trace comparing algorithm according to the expanded test results. [PENDING]
